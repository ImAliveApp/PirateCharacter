...
class AliveClass implements IAliveAgent, IStateSwitchable {
    private states: collections.Dictionary<string, BlobyState>;
    ...
    initializeStates(handler: IManagersHandler): void {
        this.states = new collections.Dictionary<string, BlobyState>();
